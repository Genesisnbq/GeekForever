...
public class LittleSupermarketConstructor {
    public String superMarketName;
    public String address;
    public int parkingCount;
    public double incomingSum;
    public MerchandiseWithConstructor[] merchandises;
     ...
     */
    public LittleSupermarketConstructor(String superMarketName, String address, int parkingCount,
                                        int merchandiseCount, int count) {
        this.superMarketName = superMarketName;
        this.address = address;
        this.parkingCount = parkingCount;

        merchandises = new MerchandiseWithConstructor[merchandiseCount];
        for (int i = 0; i < merchandises.length; i++) {
            double purchasePrice = Math.random() * 200;
            // 创建并给商品的属性赋值
            MerchandiseWithConstructor m = new MerchandiseWithConstructor(
                    "商品" + i,
                    "ID" + i,
                    count,
    ...
    public void setMerchandises(MerchandiseWithConstructor[] merchandises) {
     ...
     * @return
     */
    public MerchandiseWithConstructor getBiggestProfitMerchandise() {
        MerchandiseWithConstructor curr = null;
        for (int i = 0; i < merchandises.length; i++) {
            MerchandiseWithConstructor m = merchandises[i];
            // 这个逻辑有问题吗？相同的利润怎么判断？
     ...
     * @return
     */
    public MerchandiseWithConstructor getMerchandiseOf(int merchandiseIndex) {
