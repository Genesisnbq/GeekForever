package _02_Java_Object_Oriented_Programming._26_ConstructionMethodOverload.Supermarket;
...
//        soldPrice = 9/0;
    ...
    public Merchandise() { //这个是构建方法, 执行这个的时候, 实例还没有构建完成呢
        this("无名", "000", 0, 1.5, 1.1);//这一行必须是第一行
