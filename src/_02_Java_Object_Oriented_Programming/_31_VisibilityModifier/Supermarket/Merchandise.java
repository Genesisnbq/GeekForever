package _02_Java_Object_Oriented_Programming._31_VisibilityModifier.Supermarket;
...
public class Merchandise {
    ...
    public static Merchandise createMerchandise(String name, String id, int count,
