package _04_CommonlyToolClasses_And_NewSyntax._79_AgainGenerics.define;

import _04_CommonlyToolClasses_And_NewSyntax._79_AgainGenerics.ext.GrandParent;

// >>TODO 定义泛型, 就是把需要的类型定义在类后面的尖括号里, 然后在类里面就可以把定义好的泛型像符号一样使用
public class MyGenericClassBounded<MyType extends GrandParent> {
    // >>TODO 实际上这个引用是 GrandParent类型的
